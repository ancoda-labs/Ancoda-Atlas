...
const T = {
  ...
  receivedWarn: {
    en: 'The amount already in the fund before the flood is inside the 9.99 billion, not on top of it. The Rs 1 billion already sent to affected areas is money that left that stock. The Rs 13.5 crore released to 15 local levels, name-transfer lists, NCHL, PhonePe QR, foreign pledges, the World Bank package and in-kind cargo are not this bank stock.',
    ne: 'विपद्अघिको मौज्दात ९ अर्ब ९९ करोडभित्र छ, माथि होइन। प्रभावित क्षेत्रमा पठाइसकिएको एक अर्ब त्यही मौज्दातबाट बाहिरिएको रकम हो। १५ स्थानीय तहलाई निकासा गरिएको १३ करोड ५० लाख, नाम-हस्तान्तरण, NCHL, फोनपे QR, वैदेशिक घोषणा, विश्व बैंक प्याकेज र सामग्री यो बैंक मौज्दात होइनन्।',
  },
  notInRupee: { en: 'Counted separately, not in the rupee total', ne: 'छुट्टै गनिएको, नेपाली जम्मामा छैन' },
  notInFund: { en: 'Also published — do not add to the Rs 9.99 billion', ne: 'अन्य प्रकाशित — रु. ९ अर्ब ९९ करोडमा नजोड्नुहोस्' },
  notInFundIntro: {
  ...
  neededWarn: {
    en: 'Do not add these quantities onto the Rs 9.99 billion. The list will be updated as NDRRMA republishes it.',
    ne: 'यी परिमाण ९ अर्ब ९९ करोडमाथि नजोड्नुहोस्। एनडीआरआरएमए नयाँ सूची निकालेपछि यो अद्यावधिक हुनेछ।',
  },
...
const EXCLUSIVE_GROUPS: Array<{
  ...
  },
  {
    ...
    ids: ['pm-fund-send-1bn', 'palika-135m'],
  },
  {
    id: 'outside',
