...
const modules = [
  ...
  ['../src/apis/utils/env.mjs', 'env loader'],
  ['../src/lib/delta/engine.mjs', 'delta engine'],
  ['../src/lib/delta/memory.mjs', 'memory manager'],
  ['../src/lib/delta/index.mjs', 'delta index'],
  ['../src/lib/llm/index.mjs', 'LLM factory'],
  ['../src/lib/llm/ideas.mjs', 'LLM ideas'],
  ['../src/lib/alerts/telegram.mjs', 'telegram alerter'],
  ['../src/lib/alerts/discord.mjs', 'discord alerter'],
  ['../src/lib/synthesize.mjs', 'sweep synthesizer'],
  ['../src/apis/briefing.mjs', 'briefing orchestrator'],
  ['../src/apis/sources/seismic.mjs', 'seismic source'],
  ['../src/apis/sources/weather.mjs', 'weather source'],
  ['../src/apis/sources/firms.mjs', 'FIRMS fire source'],
  ['../src/apis/sources/airquality.mjs', 'air quality source'],
  ['../src/apis/sources/reliefweb.mjs', 'ReliefWeb source'],
  ['../src/apis/sources/nepal-news.mjs', 'hazard news aggregator'],
];
