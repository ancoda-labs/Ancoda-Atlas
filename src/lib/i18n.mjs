...
// Supported languages
const SUPPORTED_LOCALES = ['en', 'fr', 'ne'];
...
export function getLanguage() {
  // ATLAS_LANG takes priority to avoid conflict with Linux system LANGUAGE variable
  const lang = (process.env.ATLAS_LANG || process.env.LANGUAGE || process.env.LANG || DEFAULT_LOCALE)
    .toLowerCase()
    .slice(0, 2);
