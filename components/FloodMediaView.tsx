...
import type { FloodVideo, NewsItem, VideoFeed } from '@/lib/types';
        ...
        {news === null ? (
          ...
          <>
              ...
              <>
                ...
                {withImages.length > visibleNewsCount && (
                  <button
                    ...
                    style={{ display: 'block', margin: '24px auto 0', padding: '10px 24px', fontSize: '15px', borderRadius: '4px', border: '1px solid var(--line)', background: 'var(--bg-card)', color: 'var(--ink-1)', cursor: 'pointer', fontWeight: 600 }}
                  >
            ...
            {withoutImages.length > 0 && (
              <div style={{ marginTop: '32px', padding: '24px', background: 'var(--bg-card)', border: '1px solid var(--line)', borderRadius: '8px' }}>
                <h3 style={{ marginTop: 0, marginBottom: '16px', fontSize: '18px', fontWeight: 600, color: 'var(--ink-1)', borderBottom: '1px solid var(--line)', paddingBottom: '8px' }}>
